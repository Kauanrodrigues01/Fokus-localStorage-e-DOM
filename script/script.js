...
const musica = new Audio('/Fokus-DOM/sons/luna-rise-part-one.mp3')
musica.loop = true

//cronômetro
const startPauseBt = document.querySelector('#start-pause')
const audioPlay = new Audio('/Fokus-DOM/sons/play.wav')
const audioPausa = new Audio('/Fokus-DOM/sons/pause.mp3')
const audioBeep = new Audio('/Fokus-DOM/sons/beep.mp3')
...
focoBt.addEventListener('click', () => {
    imgBtComecar.setAttribute('src', '/Fokus-DOM/imagens/play_arrow.png')
...
const alterarModoDeTempo = (contexto, el, temporizador) => {
    ...
    banner.setAttribute('src', `/Fokus-DOM/imagens/${contexto}.png`)
...
const iniciarOuPausar = () => {
    ...
    imgBtComecar.setAttribute('src', '/Fokus-DOM/imagens/pause.png')
